...
function loadEvidenceMedia(){if(window.EviaEvidenceMedia||document.querySelector('script[data-evia-evidence-media-v115]'))return;const s=document.createElement('script');s.src='/Evia/assets/evia-evidence-media-v115.js?v=115';s.defer=true;s.dataset.eviaEvidenceMediaV115='1';document.head.appendChild(s)}
