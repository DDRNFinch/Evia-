...
@media(prefers-reduced-motion:reduce){.selfobs .evia-anchor .evia-float,.selfobs .evia-anchor .evia-halo,.selfobs .evia-anchor .evia-face::before{animation:none!important}.selfobs .evia-anchor .evia-eye,.selfobs .evia-anchor .evia-face{transition:none!important}}
...
function resume(){const a=anchor();if(a)a.classList.remove("evia-life-sleeping","evia-life-wake","evia-life-look-left","evia-life-look-right","evia-life-look-up","evia-life-look-down");scheduleBlink();scheduleGesture()}
...
function loadEvidenceMedia(){if(window.EviaEvidenceMedia||document.querySelector('script[data-evia-evidence-media-v115]'))return;const s=document.createElement('script');s.src=new URL('./assets/evia-evidence-media-v115.js?v=115',document.baseURI).href;s.defer=true;s.dataset.eviaEvidenceMediaV115='1';document.head.appendChild(s)}
function start(){ensureStyle();resume();watchToasts();loadEvidenceMedia()}
window.addEventListener("evia:update-available",()=>react("attention"));window.addEventListener("pageshow",()=>{resume();loadEvidenceMedia()});window.addEventListener("focus",()=>{resume();loadEvidenceMedia()});document.addEventListener("pointerdown",e=>{if(e.target.closest?.(".evia-anchor[data-evia]"))react("attention")},{passive:true,capture:true});document.addEventListener("visibilitychange",()=>{if(document.visibilityState==="visible"){resume();loadEvidenceMedia()}});if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",start,{once:true});else start();window.EviaAvatarLife=Object.freeze({version:VERSION,react,wake:resume});
})();
