...
const BUNDLED_COURSES=[
  ...
  {
    enrolmentId:"ST0171",qrPayload:"EVIA1:ST0171",title:"Property Maintenance Operative — ST0171",shortTitle:"Property Maintenance",
    courseType:"apprenticeship",qualificationId:"ST0171",pathwayId:null,packageFamilyId:"ST0171",
    packageId:"st0171-v1-1",currentPackageVersion:"1.1",packagePath:"inline:ST0171",
    content:{course:"available",multipleChoice:"not-configured",discussion:"not-configured",practical:"not-configured"},releaseChannel:"beta",publishable:true
  }
];
let cache=null;
...
async function registry(force=false){
  ...
  try{
    ...
    data=validate({eviaCourseRegistry:1,registryVersion:1,updated:"2026-08-23",qrFormat:"EVIA1:<enrolmentId>",courses:BUNDLED_COURSES})
  }
  cache=data;
  return data;
}
